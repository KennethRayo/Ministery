 ...
 * @author KGR
 */
public class JFManageChurch extends javax.swing.JFrame {

    /**
     * Creates new form JFTest
     */
    LB_Church LB = new LB_Church();
    public JFManageChurch() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable_Church = new javax.swing.JTable();
        ...
        jTable_Church.setBackground(new java.awt.Color(240, 240, 240));
        jTable_Church.setForeground(new java.awt.Color(0, 0, 0));
        jTable_Church.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        jScrollPane1.setViewportView(jTable_Church);
    ...
    private void jTextField_SearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField_SearchKeyReleased
        // TODO add your handling code here:
        LB.Search(this.jTable_Church, this.jTextField_Search.getText());
    ...
    private void jButton_RegistryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RegistryActionPerformed
        // TODO add your handling code here:
        JDChurch view = new JDChurch (this, true);
        this.dispose();
    ...
    private void jButton_DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_DeleteActionPerformed
        ...
        int rowDelete = this.jTable_Church.getSelectedRow();
        /*numero de la cantidad de filas seleccionadas
        si no se selecciona ninguna el resultado será 0*/
        int numFS = this.jTable_Church.getSelectedRowCount();
        ...
        {
            String IDD = String.valueOf(this.jTable_Church.getValueAt(rowDelete, 0));
            LB.setID_church(IDD);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFManageChurch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFManageChurch().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTable_Church;
