 ...
 * @author KGR
 */
public class JFManageDistrict extends javax.swing.JFrame {

    /**
     * Creates new form JFTest
     */
    LB_District LB = new LB_District();
    public JFManageDistrict() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable_District = new javax.swing.JTable();
        ...
        jTable_District.setBackground(new java.awt.Color(240, 240, 240));
        jTable_District.setForeground(new java.awt.Color(0, 0, 0));
        jTable_District.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        jScrollPane1.setViewportView(jTable_District);
    ...
    private void jTextField_SearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField_SearchKeyReleased
        // TODO add your handling code here:
        LB.Search(this.jTable_District, this.jTextField_Search.getText());
    ...
    private void jButton_UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_UpdateActionPerformed
        ...
        int row = this.jTable_District.getSelectedRow();
        /*numero de la cantidad de filas seleccionadas
        si no se selecciona ninguna el resultado será 0*/
        int numFS = this.jTable_District.getSelectedRowCount();

        if (row >=0 && numFS == 1)
        {
            JDDistrict MD = new JDDistrict (this, true);
            MD.jTextField_ID_District.setText(String.valueOf(this.jTable_District.getValueAt(row, 0)));
            MD.Actualizar = true;
            MD.ID = String.valueOf(this.jTable_District.getValueAt(row, 0));
            //llenar los campos con los datos de la fila seleccionada
            this.jTextField_ID.setText(String.valueOf(this.jTable_District.getValueAt(row, 0)));
            MD.jTextField_Name.setText(String.valueOf(this.jTable_District.getValueAt(row, 1)));
            this.dispose();
            MD.setVisible(true);
    ...
    private void jButton_RegistryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RegistryActionPerformed
        // TODO add your handling code here:
        JDDistrict view = new JDDistrict (this, true);
        this.dispose();
    ...
    private void jButton_DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_DeleteActionPerformed
        ...
        int rowDelete = this.jTable_District.getSelectedRow();
        /*numero de la cantidad de filas seleccionadas
        si no se selecciona ninguna el resultado será 0*/
        int numFS = this.jTable_District.getSelectedRowCount();
        ...
        {
            String IDD = String.valueOf(this.jTable_District.getValueAt(rowDelete, 0));
            LB.setID_District(IDD);
            int rptaCategory = JOptionPane.showConfirmDialog(null, "Would you like to remove the following Data Church ? \n" + IDD);
            ...
            if (rptaCategory == 0)
            {
                ...
                {
                    JOptionPane.showMessageDialog(null, "Removed Unrealized !", "AA Control - Data Church", JOptionPane.ERROR_MESSAGE);
                }
            }
            ListDistrict();
        }
        else
        {
            JOptionPane.showMessageDialog(null, "Select one row to remove ! \n\n" +
                "Once removed MF Control may not get it back", "AA Control - Church", JOptionPane.WARNING_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFManageDistrict.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFManageDistrict().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTable_District;
