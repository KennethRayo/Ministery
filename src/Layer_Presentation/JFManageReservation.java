 ...
 * @author KGR
 */
public class JFManageReservation extends javax.swing.JFrame {

    /**
     * Creates new form JFTest
     */
    LB_Reservation LB = new LB_Reservation();
    public JFManageReservation() {
        initComponents();
    ...
    {
        LB.List(this.jTable_Reservation);
    }
    /**
    ...
    private void initComponents() {
        ...
        jTable_Reservation = new javax.swing.JTable();
        ...
        jTable_Reservation.setBackground(new java.awt.Color(240, 240, 240));
        jTable_Reservation.setForeground(new java.awt.Color(0, 0, 0));
        jTable_Reservation.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
            ...
            new String [] {
                "ID", "PaymentStatus", "Payment", "DateAndTime"
            }
        ));
        jScrollPane1.setViewportView(jTable_Reservation);
    ...
    private void jTextField_SearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField_SearchKeyReleased
        // TODO add your handling code here:
        LB.Search(this.jTable_Reservation, this.jTextField_Search.getText());
    ...
    private void jButton_UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_UpdateActionPerformed
        ...
        int row = this.jTable_Reservation.getSelectedRow();
        /*numero de la cantidad de filas seleccionadas
        si no se selecciona ninguna el resultado será 0*/
        int numFS = this.jTable_Reservation.getSelectedRowCount();

        if (row >=0 && numFS == 1)
        {
            JDReservation MD = new JDReservation (this, true);
            MD.jTextField_IDReservation.setText(String.valueOf(this.jTable_Reservation.getValueAt(row, 0)));
            MD.Actualizar = true;
            MD.ID = String.valueOf(this.jTable_Reservation.getValueAt(row, 0));
            //llenar los campos con los datos de la fila seleccionada
            this.jTextField_ID.setText(String.valueOf(this.jTable_Reservation.getValueAt(row, 0)));
            MD.jSpinner_Length.setValue(Integer.parseInt("8"));
            MD.jDateChooser_DateAndTime.setDate(Date.valueOf(String.valueOf(this.jTable_Reservation.getValueAt(row, 3))));
            MD.jTextField_Payment.setText(String.valueOf(this.jTable_Reservation.getValueAt(row, 2)));
        ...
        {
            JOptionPane.showMessageDialog(null, "Select a row to continue !", "MF Control - CIF", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void jButton_RegistryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RegistryActionPerformed
        // TODO add your handling code here:
        JDReservation view = new JDReservation (this, true);
        this.dispose();
...
//        ListSubject();
    ...
    private void jButton_DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_DeleteActionPerformed
        ...
        int rowDelete = this.jTable_Reservation.getSelectedRow();
        /*numero de la cantidad de filas seleccionadas
        si no se selecciona ninguna el resultado será 0*/
        int numFS = this.jTable_Reservation.getSelectedRowCount();
        ...
        {
            String IDD = String.valueOf(this.jTable_Reservation.getValueAt(rowDelete, 0));
            LB.setID_reservation(IDD);
            ...
            if (rptaCategory == 0)
            {
                ...
                {
                    JOptionPane.showMessageDialog(null, "Removed Unrealized !", "AA Control - Reservation", JOptionPane.ERROR_MESSAGE);
                }
            }
        ...
        else
        {
            JOptionPane.showMessageDialog(null, "Select one row to remove ! \n\n" +
                "Once removed AA Control may not get it back", "MF Control - CIF", JOptionPane.WARNING_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFManageReservation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFManageReservation().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTable_Reservation;
